(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".mainpage-poster__slider")) new swiper_core_Swiper(".mainpage-poster__slider", {
            ...
            if (document.querySelector(".mainpage-games__slider")) new swiper_core_Swiper(".mainpage-games__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
            ...
            if (document.querySelector(".mainpage-product-card__slider")) new swiper_core_Swiper(".mainpage-product-card__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
...
***************************************************************************** */
        ...
        class DynamicAdapt {
            ...
            mediaHandler(matchMedia, objects) {
                if (matchMedia.matches) for (let i = 0; i < objects.length; i++) {
                    const object = objects[i];
                    object.index = this.indexInParent(object.parent, object.element);
                    this.moveTo(object.place, object.element, object.destination);
                } else for (let i = objects.length - 1; i >= 0; i--) {
                    const object = objects[i];
                    if (object.element.classList.contains(this.daClassname)) this.moveBack(object.parent, object.element, object.index);
                }
            }
        ...
        da.init();
        const parentBlocks = document.querySelectorAll(".options__item");
        parentBlocks.forEach((function(parentBlock) {
            parentBlock.addEventListener("click", (function(event) {
                if (!event.target.closest(".options__input") && !event.target.closest(".options__label")) {
                    const checkbox = parentBlock.querySelector(".options__input");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            document.addEventListener("click", (function(event) {
                ...
                const isClickableElement = target.matches(".mainpage-product__btn-like, .mainpage-btn, .mainpage-payment__btn-like") || target.closest(".mainpage-product__btn-like, .mainpage-btn, .mainpage-payment__btn-like");
                if (isClickableElement) target.closest(".mainpage-product__btn-like, .mainpage-btn, .mainpage-payment__btn-like").classList.toggle("click");
            }));
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            var popupCloseButton = document.querySelector(".popup__close");
            var menuIconButton = document.querySelector(".menu__icon");
            popupCloseButton.addEventListener("click", (function() {
                if (document.querySelector(".menu-open")) menuIconButton.click();
            }));
        }));
        const reset_filters_form = document.querySelector(".catalog-form");
        if (reset_filters_form) {
            const resetButton = reset_filters_form.querySelector(".catalog-form__button");
            if (resetButton) {
                const checkboxes = reset_filters_form.querySelectorAll('input[type="checkbox"]');
                const priceInputs = reset_filters_form.querySelectorAll(".form-range__input");
                const resetFilters = () => {
                    checkboxes.forEach((checkbox => {
                        checkbox.checked = false;
                    }));
                    priceInputs.forEach((input => {
                        if (input.id !== "price-start" && input.id !== "price-end") input.value = "";
                    }));
                };
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            function loadMoreProducts() {
                fetch("files/products.json").then((response => response.json())).then((data => {
                    ...
                    if (data.length <= page * 3) loadMoreButton.style.display = "none";
                    page++;
 ...
 */
        !function() {
            ...
            f = window.cancelAnimationFrame || window.mozCancelAnimationFrame, p = function(t, e, n) {
                ...
                for (var t, e, n, r = arguments[0], s = 2 <= arguments.length ? J.call(arguments, 1) : [], o = 0, i = s.length; o < i; o++) if (e = s[o]) for (t in e) K.call(e, t) && (n = e[t], 
                null != r[t] && "object" == typeof r[t] && null != n && "object" == typeof n ? d(r[t], n) : r[t] = n);
                return r;
            }, h = function(t) {
                for (var e, n, r = e = 0, s = 0, o = t.length; s < o; s++) n = t[s], r += Math.abs(n), 
                e++;
                return r / e;
            }, k = function(t, e) {
                var n, r;
                ...
                var s;
                return null == r && (r = !1), null == this.bindings && (this.bindings = {}), null == (s = this.bindings)[t] && (s[t] = []), 
                ...
                if (null != (r = this.bindings) && r[i]) {
                    ...
                    t = s.ctx, s = s.once, e.apply(null != t ? t : this, a), s ? o.push(this.bindings[i].splice(n, 1)) : o.push(n++);
                    return o;
                }
            }, B = Y, y = window.Pace || {}, window.Pace = y, d(y, B.prototype), T = y.options = d({}, g, window.paceOptions, k()), 
            X = 0, H = (z = [ "ajax", "document", "eventLag", "elements" ]).length; X < H; X++) !0 === T[C = z[X]] && (T[C] = g[C]);
            function Z() {
            ...
            function rt(t) {
                var e, n, r, s;
                for (null == t && (t = {}), this.complete = o(this.complete, this), this.elements = [], 
                null == t.selectors && (t.selectors = []), n = 0, r = (s = t.selectors).length; n < r; n++) e = s[n], 
            ...
            function it(t) {
                this.source = t, this.last = this.sinceLastUpdate = 0, this.rate = T.initialRate, 
                this.catchup = 0, this.progress = this.lastProgress = 0, null != this.source && (this.progress = j(this.source, "progress"));
            }
            B = Error, Q(Z, B), n = Z, $.prototype.getElement = function() {
                ...
                for (t = this.getElement(), r = "translate3d(" + this.progress + "%, 0, 0)", s = 0, 
                o = (i = [ "webkitTransform", "msTransform", "transform" ]).length; s < o; s++) e = i[s], 
                ...
                t.children[0].setAttribute("data-progress", "" + n)), y.trigger("change", this.progress), 
            ...
            }, s = tt, W = window.XMLHttpRequest, U = window.XDomainRequest, F = window.WebSocket, 
            m = function(t, e) {
                var n, r = [];
                ...
                if (!M(e)) return y.running || !1 === T.restartOnRequestAfter && "force" !== A(i) ? void 0 : (o = arguments, 
                "boolean" == typeof (e = T.restartOnRequestAfter || 0) && (e = 0), setTimeout((function() {
                ...
                this.catchup = (e - this.progress) / T.catchupTime, this.sinceLastUpdate = 0, this.last = e), 
                e > this.progress && (this.progress += this.catchup * t), e = 1 - Math.pow(this.progress / 100, T.easeFactor), 
                this.progress += e * this.rate * t, this.progress = Math.min(this.lastProgress + T.maxProgressPerFrame, this.progress), 
                ...
                return y.running = !0, w.render(), m = P(), b = !1, e = O((function(t, e) {
                    w.progress;
                    for (var n, r, s, o, i, a, u, c, l, p, h = a = 0, f = !0, g = u = 0, d = N.length; u < d; g = ++u) for (C = N[g], 
                    i = null != E[g] ? E[g] : E[g] = [], s = c = 0, l = (r = null != (p = C.elements) ? p : [ C ]).length; c < l; s = ++c) o = r[s], 
                    f &= (o = null != i[s] ? i[s] : i[s] = new v(o)).done, o.done || (h++, a += o.tick(t));
                    return n = a / h, w.update(_.tick(t, n)), w.done() || f || b ? (w.update(100), y.trigger("done"), 
                    setTimeout((function() {
        ...
        const paymentProductsContainer = document.querySelector(".mainpage-payment__products");
        const headerQuantity = document.querySelector(".header__quantity");
        document.addEventListener("DOMContentLoaded", (() => {
            updateHeaderAndNumProducts();
            updateTotalPrice();
        }));
        document.addEventListener("click", (event => {
            const target = event.target;
            if (target.matches(".mainpage-product__button, .mainpage-product__btn-cart")) {
                const productCard = target.closest(".mainpage-products__product");
                if (!productCard) return;
                const productNum = parseInt(productCard.getAttribute("data-num"));
                addToPaymentProducts(productNum);
            } else if (target.closest(".quantity__button")) handleQuantityButtonClick(target); else if (target.closest(".mainpage-payment__close-wrapper")) handleProductClose(target);
        }));
        async function addToPaymentProducts(productNum) {
            const productData = await fetchProductData(productNum);
            if (!productData) return;
            if (!paymentProductsContainer) return;
            let existingProduct = paymentProductsContainer.querySelector(`.mainpage-payment__product[data-num="${productData.num}"]`);
            if (existingProduct) {
                const quantityInput = existingProduct.querySelector(".quantity__input input");
                quantityInput.value = parseInt(quantityInput.value) + 1;
            } else {
                const paymentProduct = createPaymentProduct(productData);
                paymentProductsContainer.appendChild(paymentProduct);
                const da = new DynamicAdapt("max");
                da.init();
            }
            updateHeaderAndNumProducts();
        ...
        function createPaymentProduct(productData) {
            const randomClass = generateRandomClass();
            const paymentProduct = document.createElement("div");
            paymentProduct.classList.add("mainpage-payment__product");
            paymentProduct.setAttribute("data-num", productData.num);
            paymentProduct.innerHTML = `\n       <div class="mainpage-payment__image-wrapper">\n           <div class="mainpage-payment__image-ibg">\n               <img src="${productData.imageSrc}" alt="Картинка">\n           </div>\n       </div>\n       <div class="mainpage-payment__content-wrapper">\n           <div class="mainpage-payment__content">\n               <button type="button" class="mainpage-payment__close-wrapper" aria-label="Закрыть">\n                   <span class="mainpage-payment__close"></span>\n               </button>\n               <p class="mainpage-payment__txt">${productData.productName}</p>\n               <div class="mainpage-payment__box">\n                   <div class="mainpage-payment__price mainpage-value">\n                       <p class="mainpage-value__item-first">${productData.price}</p>\n                       <p class="mainpage-value__item-second">${productData.discount}</p>\n                       <p class="mainpage-value__item-third">${productData.originalPrice}</p>\n                   </div>\n                   <div data-da=".${randomClass},600,0" class="mainpage-payment__counter quantity">\n                       <div class="quantity__button quantity__button_minus _icon-minus"></div>\n                       <div class="quantity__input"><input autocomplete="off" type="text" aria-label="Количество" name="form[]" value="1"></div>\n                       <div class="quantity__button quantity__button_plus _icon-plus"></div>\n                   </div>\n               </div>\n               <p class="mainpage-payment__word">Регион активации<span>Россия и страны СНГ</span></p>\n               <p class="mainpage-payment__word">Сервис активации<span>Steam</span></p>\n           </div>\n           <div class="mainpage-payment__payment-buttons ${randomClass}">\n               <button type="button" class="mainpage-payment__btn-like _icon-heart" aria-label="В избранное"></button>\n           </div>\n       </div>\n   `;
            return paymentProduct;
        }
        function handleQuantityButtonClick(button) {
            const quantityInput = button.closest(".quantity").querySelector("input");
            let value = parseInt(quantityInput.value);
            if (button.classList.contains("quantity__button_plus")) value++; else value = Math.max(1, value - 1);
            quantityInput.value = value;
            updateHeaderAndNumProducts();
            updateTotalPrice();
        }
        function handleProductClose(button) {
            const productContainer = button.closest(".mainpage-payment__product");
            if (!productContainer) return;
        ...
        function generateRandomClass() {
            ...
            for (let i = 0; i < 12; i++) result += characters.charAt(Math.floor(Math.random() * charactersLength));
            return result;
        }
        function updateHeaderAndNumProducts() {
            const quantityInputs = document.querySelectorAll(".mainpage-payment__products .quantity__input input");
            let totalQuantity = 0;
            ...
            if (numProductsElement) numProductsElement.textContent = totalQuantity;
        }
        function updateTotalPrice() {
            const productContainers = document.querySelectorAll(".mainpage-payment__product");
            let totalPrice = 0;
            productContainers.forEach((container => {
                const priceElement = container.querySelector(".mainpage-value__item-first");
                const quantityInput = container.querySelector(".quantity__input input");
                const price = parseFloat(priceElement.textContent.replace(/\s/g, ""));
                const quantity = parseInt(quantityInput.value);
                totalPrice += price * quantity;
            }));
            const sumProductsElement = document.getElementById("sumProducts");
            if (sumProductsElement) sumProductsElement.textContent = totalPrice.toLocaleString("ru-RU");
        }
        document.addEventListener("DOMContentLoaded", (function() {
            const productsContainer = document.querySelector(".mainpage-payment__products");
            const infoElement = document.querySelector(".mainpage-payment__info");
            function toggleElementsVisibility() {
                const hasProducts = productsContainer.querySelectorAll(".mainpage-payment__product").length > 0;
                infoElement.style.display = hasProducts ? "none" : "block";
                setTimeout((() => {
                    infoElement.classList.toggle("show", !hasProducts);
                }), hasProducts ? 200 : 0);
            }
